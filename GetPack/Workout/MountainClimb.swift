        ...
        NavigationStack {
            ZStack {
                GeometryReader { geometry in
                    VStack {
                        HStack {
                            NavigationLink(destination: MountainResume()) {
                                CloseButtonWO()
                            }
...
//                        .padding()
                    ...
                    HStack {
                        NavigationLink(destination: RestMountain()) {
                            PreviousButton()
                        }
                        .padding(.vertical,10)
    ...
    func playSound() {
        if let path = Bundle.main.path(forResource: "Mountain Climber", ofType: "m4a") {
            do {
