...
struct RestAbdominal: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            NavigationLink(destination: Abdominal1(), isActive: $navigate) {
                EmptyView()
            }
        }
        .onAppear {
            abdominalCrunchesSound.play()
        }
        .onDisappear {
            stopAllSounds()
        }
