...
struct RestPlank: View {
    ...
    let restPlankSound = AVPlayer(url: Bundle.main.url(forResource: "Rest Plank", withExtension: "m4a")!)
    ...
    var body: some View {
        NavigationStack {
            ...
            NavigationLink(destination: Plank1(), isActive: $navigate) {
                EmptyView()
            }
        }
