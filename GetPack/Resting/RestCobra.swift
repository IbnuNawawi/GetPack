...
struct RestCobra: View {
    ...
    let restCobraSound = AVPlayer(url: Bundle.main.url(forResource: "Rest Cobra", withExtension: "m4a")!)
    ...
    var body: some View {
        NavigationStack {
            ZStack {
                ...
                VStack {
                    CustomVideoPlayerView(videoName: "Cobra Video", videoType: "mov")
                        .scaledToFit()
                        .background(.white)
                        .cornerRadius(50)
            ...
            NavigationLink(destination: CobraStretch(), isActive: $navigate) {
                EmptyView()
            }
        }
